...
void printHelp()
{
    std::cout << "CS637 HW EXTRA" << std::endl;
    std::cout << "GLSL version in use: " << glGetString(GL_SHADING_LANGUAGE_VERSION) << std::endl;
    std::cout << "    About: displays an arm configuration." << std::endl;
    std::cout << "    Usage: " << std::endl;
    std::cout << "Right mouse button click for menu." << std::endl;
    std::cout << "Left mouse button click to move selected part." << std::endl;
    std::cout << "\t r / R \t Increase / Decrease spherical camera radius." << std::endl;
    std::cout << "\t o / O \t Increase / Decrease spherical camera angle W/E." << std::endl;
    std::cout << "\t p / P \t Increase / Decrease spherical camera angle N/S." << std::endl;
    std::cout << "Press 'Esc' or 'q' or 'Q' to exit. " << std::endl;
    std::cout << "    " << std::endl;
}
