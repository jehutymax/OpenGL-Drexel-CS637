...
As per the assignment specifications, the application:
 - Part 1: Displays 2D objects: sequence of squares, circle, ellipse and triangle.
 - Part 2: Displays 3 new 2D objects: fake 3D pyramid, sequence of circles and an octagon.
